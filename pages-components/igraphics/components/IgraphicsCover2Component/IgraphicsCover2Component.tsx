...
export const IgraphicsCover2Component = forwardRef(({ game, schema, pattern }: { game: Game; schema: any; pattern: any }, ref) => {
    ...
    <div className={s.tableWrapper}>
      <div className={s.container}>
        ...
        <div className={s.name}>
          <div className={s.text} style={{ color: schema.colors.linkFont, background: schema.colors.titleBg }}>
            <AutosizeInput onChange={e => setText(e.target.value)} value={text} inputStyle={{ fontSize: 190, color: schema.colors.titleFont }} />
          </div>
