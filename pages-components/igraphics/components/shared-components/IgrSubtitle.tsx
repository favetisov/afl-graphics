...
export const IgrSubtitle = forwardRef(
  (
    {
      schema,
      first,
      second,
      light,
    }: { first: string; second: string; schema: any; light?: boolean },
    ref
  ) => {
            ...
            <div
              ...
              style={{
                backgroundColor: light
                  ? schema.colors.subTitleDelimiterLight
                  : schema.colors.subTitleDelimiter,
              }}
            />
            <AutosizeInput
              onChange={(e) => {
