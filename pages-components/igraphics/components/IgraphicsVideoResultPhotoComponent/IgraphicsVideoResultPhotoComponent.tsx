...
export const IgraphicsVideoResultPhotoComponent = forwardRef(({ game, schema, pattern }: any, ref) => {
  ...
  const filterEvents = (team: Team) =>
    game.events.filter(e => [GameEventType.F_GOAL, GameEventType.F_RED, GameEventType.F_YELLOW, GameEventType.F_SECOND_YELLOW].includes(e.type) && e.team?._id == team._id);
  ...
  return (
    <div className={s.tableWrapper}>
      <div className={s.background} style={{ background: `linear-gradient(0deg, ${schema.colors.bg} 10%, rgba(0, 0, 0, 0) 59.21%)` }} />
      ...
      <div className={s.content}>
        ...
        <div className={s.body} style={{ background: schema.colors.bg }}>
          ...
          <div className={s.bottom}>
            <IgrAflRegion light league={game.stage.season.champ.country.league} schema={schema} />
