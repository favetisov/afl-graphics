  ...
  return (
    <div className={s.tableWrapper}>
      <IgrCardWrapper schema={schema} pattern={pattern}>
        ...
        <div style={{ background: schema.colors.bar }} className={s.borderTop} />
        <div className={s.content}>
          <div style={{ borderColor: schema.colors.bar }} className={s.info}>
            <input style={{ color: schema.colors.subTitleFont }} className={s.firstName} value={firstName} onChange={e => setFirstName(e.target.value)} />
            <input style={{ color: schema.colors.subTitleFont }} className={s.lastName} value={lastName} onChange={e => setLastName(e.target.value)} />
            <div className={s.age} style={{ color: schema.colors.linkFont }}>
              <AutosizeInput onChange={e => setValue(e.target.value)} value={value} inputStyle={{ color: schema.colors.titleFont, background: schema.colors.titleBg }} />
            </div>
          </div>
          <div className={s.playerPhoto}>
            <PhotoLoader className={s.photo} defaultUrl={'/igraphics/demo/messi.jpg'} onImg={() => {}} height={1500} width={1500} />
        ...
        <div style={{ background: schema.colors.bar }} className={s.borderBottom} />
