    ...
    return (
      <div>
        <Select
          ...
          mt={'xs'}
        />
        <IgrSchemaSelect onSchemaSelect={setSchema} onPatternSelect={setPattern} />
        {currentElement}
      </div>
    );
  };
      ...
      if (currentComponent.value == 'team') {
          ...
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsTeamComponent schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsQuoteComponent schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsMvpPlayerComponent schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsMvpPlayer2Component schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsAchievementTeamComponent schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsAnnouncementComponent schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsBirthday schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div ref={containerRef}>
              <div ref={el => scaleContainer(el, 4000)} className={s.imgContainer + ' igr-container'}>
                <IgraphicsInfoComponent schema={schema} pattern={pattern} league={league} />
              </div>
            </div>
          </>
        );
    ...
    <>
      <Title order={2} my={'sm'}>
        <Group position={'apart'}>
          Social graphics
          <Button mt={'md'} onClick={() => exportAsImage('standings.png')} disabled={downloading}>
            DOWNLOAD IMAGE
